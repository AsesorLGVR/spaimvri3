...
if (p1==1) {document.getElementById('demo0').innerHTML="vivo",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="vives",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="vive",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="vivimos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="viven",document.getElementById('demo5').style.color = "#00FF00";}
