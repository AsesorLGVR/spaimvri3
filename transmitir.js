...
if (p1==1) {document.getElementById('demo0').innerHTML="transmito",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="transmites",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="transmite",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="transmitimos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p5==1) {document.getElementById('demo4').innerHTML="transmitís",document.getElementById('demo4').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="transmiten",document.getElementById('demo5').style.color = "#00FF00";}
