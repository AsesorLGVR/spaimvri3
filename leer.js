...
if (p1==1) {document.getElementById('demo0').innerHTML="o",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="e",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="emos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="en",document.getElementById('demo5').style.color = "#00FF00";}
