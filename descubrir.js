...
if (p1==1) {document.getElementById('demo0').innerHTML="descubro",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="descubres",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="descubre",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="descubrimos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p5==1) {document.getElementById('demo4').innerHTML="descubrís",document.getElementById('demo4').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="descubren",document.getElementById('demo5').style.color = "#00FF00";}
