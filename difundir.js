...
if (p1==1) {document.getElementById('demo0').innerHTML="difundo",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="difundes",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="difunde",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="difundimos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p5==1) {document.getElementById('demo4').innerHTML="difundís",document.getElementById('demo4').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="difunden",document.getElementById('demo5').style.color = "#00FF00";}
...
if(document.getElementById('estoy').selected==true && document.getElementById('estas').selected==true && document.getElementById('esta').selected==true && document.getElementById('estamos').selected==true && document.getElementById('estais').selected==true && document.getElementById('estan').selected==true){correcto.play() && alert('No te conformes con lo que necesitas, lucha por lo que te mereces.')}
