...
if (p1==1) {document.getElementById('demo0').innerHTML="escondo",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="escondes",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="esconde",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="escondemos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p5==1) {document.getElementById('demo4').innerHTML="escondéis",document.getElementById('demo4').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="esconden",document.getElementById('demo5').style.color = "#00FF00";}
...
if(document.getElementById('estoy').selected==true && document.getElementById('estas').selected==true && document.getElementById('esta').selected==true && document.getElementById('estamos').selected==true && document.getElementById('estais').selected==true && document.getElementById('estan').selected==true){correcto.play() && alert('Céntrate hacia dónde quieres ir, no en lo que temes.')}
