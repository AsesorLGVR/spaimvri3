...
if (p1==1) {document.getElementById('demo0').innerHTML="discuto",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="discutes",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="discute",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="discutimos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="discuten",document.getElementById('demo5').style.color = "#00FF00";}
