...
if (p1==1) {document.getElementById('demo0').innerHTML="comprometo",document.getElementById('demo0').style.color = "#00FF00";}
...
if (p2==1) {document.getElementById('demo1').innerHTML="comprometes",document.getElementById('demo1').style.color = "#00FF00";}
...
if (p3==1) {document.getElementById('demo2').innerHTML="compromete",document.getElementById('demo2').style.color = "#00FF00";}
...
if (p4==1) {document.getElementById('demo3').innerHTML="comprometemos",document.getElementById('demo3').style.color = "#00FF00";}
...
if (p5==1) {document.getElementById('demo4').innerHTML="comprometéis",document.getElementById('demo4').style.color = "#00FF00";}
...
if (p6==1) {document.getElementById('demo5').innerHTML="comprometen",document.getElementById('demo5').style.color = "#00FF00";}
...
if(document.getElementById('estoy').selected==true && document.getElementById('estas').selected==true && document.getElementById('esta').selected==true && document.getElementById('estamos').selected==true && document.getElementById('estais').selected==true && document.getElementById('estan').selected==true){correcto.play() && alert('Sigue corriendo, no dejes que tus excusas te alcancen.')}
